...
public class BaseController {
	...
	private void onAddTask() {
		...
		try {
			...
			boolean saveClicked = controller.isSaveClicked();
			if(saveClicked) {
				if(controller.getTask() != null) {
					AppData.getMasterTaskList().add(controller.getTask());
					System.out.println(AppData.getMasterTaskList());
				} else {
					//user did not fill out any information
					Dialogs.create().title("Information")
					.masthead("Incorrect Information")
					.masthead("Please enter the correct information.")
					.showWarning();
				}
			}
		} catch (Exception e) {
		...
		try {
			...
			if(saveClicked) {
				if(controller.getCourse() != null) {
					AppData.getMasterCourseList().add(controller.getCourse());
				} else {
					//user did not fill out any information
					Dialogs.create().title("Information")
					.masthead("Incorrect Information")
